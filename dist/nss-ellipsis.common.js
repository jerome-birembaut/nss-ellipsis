...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return NSSEllipsis; });
...
function () {
  ...
  _createClass(NSSEllipsis, null, [{
    ...
    value: function update(element) {
      ...
      var _text = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;

      var txt = _text != null ? _text.split(' ') : element.innerText.split(' ');
...
var NSSEllipsis = __webpack_require__(/*! ./index */ "./src/index.js");
...
/******/ });
//# sourceMappingURL=nss-ellipsis.common.js.map